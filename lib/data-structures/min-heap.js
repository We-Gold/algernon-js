 ...
 * @param {getValueFunction} [getValue] Returns the value to min heap with of the current element
...
/**
 * @callback getValueFunction
 * @param {*} value The value of any particular node
 * @returns {number} The number to use for heap order
 */
