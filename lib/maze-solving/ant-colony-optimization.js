import { Visited, cellAt, cellIs, createFilledMatrix, getAvailableNeighbors } from "../helpers"
...
export const solveACO = (rawMaze, start, goal, config = defaultACOConfig) => {
	...
	const pheromoneMatrix = createFilledMatrix(rawMaze.length, rawMaze[0].length, 0)
