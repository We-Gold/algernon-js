 ...
 */
export const solveAStar = (rawMaze, start, goal, h = AStarHeuristic.hypot, edgeCost = 1) => {
 ...
 * @type {heuristic}
 */
export const hypotHeuristic = (([row, col], [otherRow, otherCol]) => {
 ...
 * @type {heuristic}
 */
export const gridHeuristic = (([row, col], [otherRow, otherCol]) => {
