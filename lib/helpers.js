 ...
 * @param {Array} index
 * @param {Array[]} cells
 * @returns The binary data in the cell
 */
 ...
 * @returns Whether or not the cell matches the condition
 */
 ...
 * @param {Array} currentCell
 * @param {Array} neighborCell
 * @returns The cardinal direction as a binary mask
 */
 ...
 * @param {number[]} cell
 * @param {number[][]} cells
 * @returns All unvisited neighbors of the cell
 */
 ...
 * @param {number[]} cell
 * @param {number[][]} cells
 * @returns All available neighbors of the current cell
 */
